...
<template>
  <div class="flex flex-row w-full h-full dark:bg-gray-700">
    ...
    >
      ...
      >
        ...
        >
          <Icon
            icon="uil:setting"
            class="w-[20px] h-[20px] inline-block mr-2 hover:text-gray-500"
          />
        </button>
      </div>
    </div>
    <ScrollArea class="flex flex-col flex-grow h-screen p-2 bg-white dark:bg-gray-700 mt-10">
      <div
        v-for="recently_used in recently_used_list"
        :key="recently_used.uid"
      ...
      >
        ...
        <div class="flex-grow">
          <h6 class="text-sm text-black dark:text-white group-hover:text-white">
            {{ recently_used.name }}
          </h6>
          <div class="flex flex-row items-center justify-between mt-2">
            <span class="text-xs text-gray-400 group-hover:text-white">{{
              recently_used.type
            }}</span>
